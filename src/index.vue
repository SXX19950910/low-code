...
import dragField from './components/drag.vue'
...
import addressBookOptions from './public/addressBookOptions'
import dateAreaOptions from './public/dateAreaOptions'
import buttonOptions from './public/buttonOptions'
import configTableOptions from './advanced/options/configTable'
import buttonDrawerOptions from './advanced/options/buttonDrawer'
...
import richTextOptions from './advanced/options/richText'
import carouselOptions from './public/carouselOptions'
import slideDisplayOptions from './advanced/options/slideDisplay'
