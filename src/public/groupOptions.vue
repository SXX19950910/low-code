<template>
  <el-form class="group-options-warp" label-position="top">
    <div class="title-top">
      当前选中：{{ current.type }}
    </div>
    <el-collapse>
      <el-collapse-item title="基础">
        ...
        <el-form-item v-if="current.field.moreSliceNumber" label="初始显示数量">
          <el-input-number v-model="current.field.moreSliceNumber" class="w-100" />
        </el-form-item>
      </el-collapse-item>
