<template>
  <el-form class="textarea-options-warp" label-position="top">
    <div class="title-top">
      当前选中：{{ current.type }}
    </div>
    <el-collapse>
      <el-collapse-item title="基础">
        ...
        <el-form-item label="行数">
          <el-input-number v-model="current.field.props.rows" class="w-100" />
        </el-form-item>
        <el-form-item label="最大长度">
          <el-input-number v-model="current.field.props.maxlength" class="w-100" />
        </el-form-item>
        <el-form-item label="缩放">
          <el-select v-model="current.field.props.resize" class="w-100">
      ...
      <el-collapse-item title="常用">
        <div class="handle-table">
          ...
          <div class="body-sub">
            <div class="item">
              <div class="name">数字统计</div>
              <el-checkbox v-model="current.field.props.showWordLimit" />
            </div>
            <div class="item">
              <div class="name">自适应高度</div>
              <el-checkbox v-model="current.field.props.autosize" />
            </div>
            <div class="item">
